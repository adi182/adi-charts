...
import ADIDonut from './components/ADIDonut.vue';

export { ADIChart, ADIXAxis, ADILine, ADIYAxis, ADIBar, ADIPoints, ADILabel, ADIDonut };
...
export function install(app: App) {
  ...
  app.component('ADIDonut', ADIDonut);
}
